...
<?php
    ...
    public function widget($args, $instance) {
		...
		";}
		$data .= "<div class='copy' style='color:#ccc; font-size: 9px; '><a href='http://www.amazon.com/ChomChom-Roller/dp/B00BAGTNAQ' title='click here' target='_blank'>Cat Hair Remover</a></div>";
		echo $before_widget;
